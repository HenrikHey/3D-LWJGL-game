...
public class Terrian {
    ...
    private static final float MAX_HEIGHT = 70, MAX_PIXEL_VALUE = 256 * 256 * 256;
    ...
    public Terrian(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack,
